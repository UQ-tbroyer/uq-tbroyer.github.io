const translations = {
  en: {
    ...
    navContact: "Contact",
    subname: "Computer Engineering Student and CEP",
    ...
    workTitle0: "Intern",
    workCompany0: "Beneva",
    workDate0: "May 2026 - Now",
    workTask0_1: "Integration of tests in CI pipeline",
    workTask0_2: "Adding features to existing software",
    workTask0_3: "Adding maintenance mecanism",
    workTask0_4: "Working with custom AI agent",
    workTitle1: "Intern",
    workCompany1: "Centre de Production Automatisé (CPA)",
    workDate1: "Apr. 2023 - Apr. 2026",
  ...
  fr: {
    ...
    navProjects: "Projets",
    navContact: "Contact",
    subname: "Étudiant en Génie Informatique et CPI",
    ...
    workTitle0: "Stagiaire",
    workCompany0: "Bénéva",
    workDate0: "Mai 2026 - présent",
    workTask0_1: "Intégrer des tests dans un flux CI",
    workTask0_2: "Ajouter des fonctionnalités dans un système existant",
    workTask0_3: "Ajouter des mécanismes de maintenance",
    workTask0_4: "Travailler avec des agents IA personnalisés",
    workTitle1: "Stagiaire",
    workCompany1: "Centre de Production Automatisé (CPA)",
    workDate1: "Avr. 2023 - Avr. 2026",
...
function setLanguage(lang) {
  ...
  const map = {
    ...
    "work-title0": t.workTitle0,
    "work-company0": t.workCompany0,
    "work-date0": t.workDate0,
    "work-task0-1": t.workTask0_1,
    "work-task0-2": t.workTask0_2,
    "work-task0-3": t.workTask0_3,
    "work-task0-4": t.workTask0_4,
